...
function KIAPicanto() {
  return (
    ...
    <h1 className="text-center text-3xl font-bold underline ">KIA Picanto 2024 Price in Pakistan,Images,Reviews & Spaces</h1>
    
    <div className="flex justify-center items-center py-6">
        <div className="bg-slate-500 h-fit w-72"><Image src={"/Picanto.png"} alt="car" height={450} width={450}/></div>
    </div>
        ...
        <div className="flex flex-col justify-center items-center">
            ...
            <h1 className="text-2xl text-green-600 font-medium text-center py-6">PKR 450,000,000</h1>
