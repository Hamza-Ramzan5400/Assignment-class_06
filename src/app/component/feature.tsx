...
<div className=" bg-slate-100">
        ...
        <div className=" bg-slate-100 flex justify-center items-center gap-3 h-80 w-full">
            <div ><Link href="/toyotacorola_car">
            <Image 
            src={"/corolla.jpg"} 
            alt="car" 
            width={600} 
            height={600} 
            className="bg-white h-60 w-60 rounded-lg"/></Link>
            ...
            <div><Link href="/suzukicar_car"><Image src={"/Suzuki_Alto.png"} alt="car" width={600} height={600} className="bg-white h-60 w-60 rounded-lg"/></Link>
            ...
            <div><Link href="/hondacity_car"><Image src={"/Honda_City.jpg"} alt="car" height={600} width={600} className="bg-white h-60 w-60 rounded-lg"/></Link>
            ...
            <div><Link href="/kiapicanto_car"><Image src={"/Picanto.png"} alt="car" width={600} height={600} className="bg-white h-60 w-60 rounded-lg"/></Link>
